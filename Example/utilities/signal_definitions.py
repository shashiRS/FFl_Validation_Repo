...
from tsf.io.compliance import ComplianceDefinition
...
class ExampleSignalsCompliance(ComplianceDefinition):
    """Example signal reading mapping for EBA signals."""

    class Columns(ComplianceDefinition.Columns):
        """Column defines."""
    ...
    def __init__(self):
        ...
        self._properties = {
            self.Columns.ACTIVATION_A: "Example Signal Data 1.activation.sig_a",
            self.Columns.ACTIVATION_B: "Example Signal Data 1.activation.sig_b",
            self.Columns.BINARY_ACTIVATION_A: "Example Signal Data 1.binary_activation_a",
            self.Columns.BINARY_ACTIVATION_B: "Example Signal Data 1.binary_activation_b",
            self.Columns.ECU: "ecu_signal",
            self.Columns.SIL: "sil_signal",
            self.Columns.SIG_A: "Example Signal Data 2.some_sig_a",
            self.Columns.SIG_B: "Example Signal Data 2.some_sig_b",
            self.Columns.SIG_X: "Example Signal Data 2.some_other_sig_x",
        }
