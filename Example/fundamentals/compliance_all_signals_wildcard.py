...
from tsf.io.compliance import ComplianceDefinition, ComplianceProp


from utilities.generate_data import generate_bsig_compliance, ExampleSignalsCompliance
...
class ExampleSignals(ExampleSignalsCompliance):
    ...
    def __init__(self):
        ...
        self._properties = {
            self.Columns.ALL_SIGNALS: ComplianceProp(signals="", tolerance=[0.1, 0.1], expected_result='> 50%')
        }
...
class ExampleActivation(TestStep):
    ...
    def process(self):
        ...
        ecu_df = example_signals['ecu_signal'][ex.index_offset['ecu']:]
        sil_df = example_signals['sil_signal'][ex.index_offset['sil']:]
        activation = example_signals.loc[(example_signals["Example Signal Data 1.activation.sig_a"] != 0)]
