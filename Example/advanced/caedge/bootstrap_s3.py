...
def main(workdir: str, **kwargs):
    ...
    s3_rec_urls = [
        "s3://honda-datalake-drivedata-prj-qa/20211025054543_33/2021.10.25_at_05.45.37_radar-mi_5356.rrec",
    ]
    ...
    cfg.testcase_names = [
        "caedge.examples2.ExampleAllTestCase",
    ]
    cfg.path_specs = [
        # PathSpecification("s3://honda-datalake-drivedata-sim-qa/fot2kpi/stage2/bsigs/adcu_eba/ADCUSIL_R72_Beat1_HA22.00.09.01.0.019/bin_data_1", suffix="*", extension=".bsig"),
