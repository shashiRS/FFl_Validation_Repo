...
if __name__ == "__main__":
    ...
    recipient_email = ['puram.hari.sudarshan.rahul@continental-corporation.com','shashikala.r.s@continental-corporation.com','devendra.ogi@continental-corporation.com']
